...
<div class="row align-items-center">
	...
	if ( isset( $ciyashop_options['fourofour_page_content_source'] ) && 'page' === $ciyashop_options['fourofour_page_content_source'] && isset( $ciyashop_options['fourofour_page_content_page'] ) && '' != $ciyashop_options['fourofour_page_content_page'] ) {
		global $post;
				...
				<article id="post-<?php echo esc_attr( $article_id ); ?>" <?php post_class( $article_class ); ?>>
					<div class="entry-content" style="<?php echo esc_attr( $content_css ); ?>">
						...
						if ( 'page' === $page_content_type ) {
							...
							$wp_query->query( 'page_id=' . (int) $fourofour_page_id );
