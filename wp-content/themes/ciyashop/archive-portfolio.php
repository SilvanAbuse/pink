...
if ( isset( $ciyashop_options['display_portfolio_categories_filters'] ) && 1 == $ciyashop_options['display_portfolio_categories_filters'] ) {
			...
			<div id="primary" class="content-area">
				<main id="main" class="site-main" role="main">
					<div class="<?php echo esc_attr( $portfolio_section_classes ); ?>">
						<?php
						if ( isset( $ciyashop_options['display_portfolio_categories_filters'] ) && 1 == $ciyashop_options['display_portfolio_categories_filters'] && ! is_wp_error( $filter_terms ) && is_array( $filter_terms ) && ! empty( $filter_terms ) ) {
							?>
