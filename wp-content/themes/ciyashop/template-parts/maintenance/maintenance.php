			...
			<div class="col-lg-12 col-md-12">
				...
				if ( 'comingsoon' == $maintenance_mode ) {
					...
					if ( empty( $comingsoon_date ) ) {
						$comingsoon_date = date( 'm/d/Y', strtotime( '+1 months' ) );
					}
				...
				if ( isset( $ciyashop_options['comming_soon_social_icons'] ) && 1 == $ciyashop_options['comming_soon_social_icons'] && ! empty( $social_icons ) ) {
					?>
