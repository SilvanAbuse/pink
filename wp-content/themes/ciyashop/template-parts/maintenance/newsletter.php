...
if ( ( isset( $ciyashop_options['comming_soon_newsletter'] ) && 1 == $ciyashop_options['comming_soon_newsletter'] ) && ( ciyashop_check_plugin_active( 'mailchimp-for-wp/mailchimp-for-wp.php' ) ) && ( isset( $ciyashop_options['comming_page_newsletter_shortcode'] ) && ! empty( $ciyashop_options['comming_page_newsletter_shortcode'] ) ) ) {
				...
				<div class="col-sm-8"> 
					...
					<form id="mc4wp-form-1" class="notify-form mc4wp-form mc4wp-form-<?php echo esc_attr( $mailchimp_id ); ?>" method="post" data-id="<?php echo esc_attr( $mailchimp_id ); ?>" data-name="NewsLetter">
						<div class="mc4wp-form-fields">
							...
							<input class="newsletter_submit" value="<?php esc_html_e( 'Notify Me', 'ciyashop' ); ?>" type="submit">
