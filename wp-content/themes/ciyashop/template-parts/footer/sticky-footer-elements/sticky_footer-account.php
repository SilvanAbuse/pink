...
if ( class_exists( 'WooCommerce' ) ) {
	...
	<div class="<?php echo esc_attr( $woo_account_classes ); ?>">
		<a href="<?php echo wc_get_page_permalink( 'myaccount' ); ?>" title="<?php esc_attr_e( 'My Account', 'ciyashop' ); ?>"><i class="vc_icon_element-icon glyph-icon pgsicon-ecommerce-avatar"></i></a>
	</div>
	<?php
}
