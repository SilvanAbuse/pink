...
<div id="tabs" class="tabs_wrapper">
	<ul class="tabs">
		...
		foreach ( $faq_page_tabs_data as $faq_page_query ) {
			?>
			<li data-tabs="tab_<?php echo esc_attr( $faq_page_query['slug'] ); ?>" class="<?php echo esc_attr( 1 == $faq_page_query_tab_sr ? 'active' : '' ); ?>"><?php echo esc_html( $faq_page_query['title'] ); ?></li>
			<?php
	...
	foreach ( $faq_page_tabs_data as $faq_page_query ) {
		?>
		<div id="tab_<?php echo esc_attr( $faq_page_query['slug'] ); ?>" class="tabcontent <?php echo esc_attr( 1 == $faq_page_query_tab_content_sr ? 'active' : '' ); ?>">
			<?php
