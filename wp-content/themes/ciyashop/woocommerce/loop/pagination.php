...
$product_pagination = isset( $ciyashop_options['product_pagination'] ) ? $ciyashop_options['product_pagination'] : '';

if ( ! empty( $product_pagination ) && ( 'load_more' == $product_pagination || 'infinite_scroll' == $product_pagination ) ) {

	$load_more_button_style = ( 'infinite_scroll' == $product_pagination ) ? 'pointer-events: none; cursor: default;' : '';
