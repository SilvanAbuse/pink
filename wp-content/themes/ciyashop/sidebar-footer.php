...
if ( isset( $ciyashop_options['footer_five_alignment'] ) && '' != $ciyashop_options['footer_five_alignment'] ) {
	$footer_widget_columns_alignment[] = 'footer-align-' . $ciyashop_options['footer_five_alignment'];
}

if ( isset( $ciyashop_options['footer_six_alignment'] ) && '' != $ciyashop_options['footer_six_alignment'] ) {
	$footer_widget_columns_alignment[] = 'footer-align-' . $ciyashop_options['footer_six_alignment'];
}

if ( isset( $ciyashop_options['footer_seven_alignment'] ) && '' != $ciyashop_options['footer_seven_alignment'] ) {
...
if ( $sidebar_content > 0 ) {
	...
	<?php
	if ( ( isset( $ciyashop_options['footer_bottom'] ) && 'show' === $ciyashop_options['footer_bottom'] ) && ( isset( $ciyashop_options['footer_bottom_content'] ) && '' != $ciyashop_options['footer_bottom_content'] ) ) {
		?>
