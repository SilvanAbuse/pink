 ...
 */
add_action( 'wp_ajax_ciyashop_options_ajax_save', 'ciyashop_color_customize_ajax_save', 9 );
function ciyashop_color_customize_ajax_save() {
	...
	$values = isset( $_POST['data'] ) ? $redux->redux_parse_str( $_POST['data'] ) : array();
	...
	if ( 'predefined' == $header_type_select ) {
		$header_schema = '';
	} else {
...
.woocommerce-account .woocommerce-MyAccount-content .order-number, .woocommerce-account .woocommerce-MyAccount-content .order-date, .woocommerce-account .woocommerce-MyAccount-content .order-status{ color: ' . $primary_color . '; }
...
.latest-post-style-6 .latest-post-entry-footer > a:hover, .latest-post-style-7 .latest-post-entry-footer > a:hover, .newsletter-wrapper.newsletter-style-2.newsletter-bg-type-light .input-area input[type=text]:focus, .theme-dark .newsletter-wrapper.newsletter-style-3 .newslatter-form .input-area input[type=text]:focus, .wpb-js-composer .content-wrapper .vc_tta.vc_tta-style-modern .vc_tta-panel.vc_active .vc_tta-panel-heading, .wpb-js-composer .content-wrapper .vc_tta.vc_tta-style-outline .vc_tta-panel-heading:focus .vc_tta-controls-icon::after, .wpb-js-composer .content-wrapper .vc_tta.vc_tta-style-outline .vc_tta-panel-heading:focus .vc_tta-controls-icon::before, .wpb-js-composer .content-wrapper .vc_tta.vc_tta-style-outline .vc_tta-panel-heading:hover .vc_tta-controls-icon::after, .wpb-js-composer .content-wrapper .vc_tta.vc_tta-style-outline .vc_tta-panel-heading:hover .vc_tta-controls-icon::before { border-color: ' . $primary_color . '; }
	...
	/* Background Color */
	.woocommerce .gridlist-toggle a:hover, .woocommerce .gridlist-toggle .active, .woocommerce .gridlist-toggle .gridlist-button:hover, .woocommerce .gridlist-toggle .gridlist-button.active { background-color: ' . $primary_color . '; }
	...
	if ( '' != $header_schema && is_array( $header_schema ) ) {

		foreach ( $header_schema as $key => $value ) {

			if ( 'menu_color_schema' == $key ) {
				...
				foreach ( $value as $menu_position => $menu_color ) {
					foreach ( $menu_color as $menu_color_key => $menu_color_value ) {
						foreach ( $menu_color_value as $menu_key => $menu_value ) {
							...
							if ( isset( $menu_value['menu_colors_color'] ) && '' != $menu_value['menu_colors_color'] ) {
								$menu_colors_color = 'color: ' . $menu_value['menu_colors_color'] . ';';
							}

							if ( isset( $menu_value['menu_colors_link_color'] ) && '' != $menu_value['menu_colors_link_color'] ) {
								$menu_link_color = 'color: ' . $menu_value['menu_colors_link_color'] . ';';
							}

							if ( isset( $menu_value['menu_colors_hover_color'] ) && '' != $menu_value['menu_colors_hover_color'] ) {
			...
			} elseif ( 'primary_menu_color_schema' == $key ) {
				...
				foreach ( $value as $menu_position => $menu_color ) {
					foreach ( $menu_color as $menu_color_key => $menu_color_value ) {
						foreach ( $menu_color_value as $menu_key => $menu_value ) {
							...
							if ( isset( $menu_value['menu_bg_color'] ) && '' != $menu_value['menu_bg_color'] ) {
				...
				if ( isset( $value['row_height_desktop'] ) && '' != $value['row_height_desktop'] ) {
					$desktop_height = 'height: ' . $value['row_height_desktop'] . 'px;';
				}

				if ( isset( $value['row_height_mobile'] ) && '' != $value['row_height_mobile'] ) {
					$mobile_height = 'height: ' . $value['row_height_mobile'] . 'px;';
				}

				if ( isset( $value['header_color_color'] ) && '' != $value['header_color_color'] ) {
					$color = 'color: ' . $value['header_color_color'] . ';';
				}
				if ( isset( $value['header_color_link_color'] ) && '' != $value['header_color_link_color'] ) {
				...
				if ( isset( $value['header_color_hover_color'] ) && '' != $value['header_color_hover_color'] ) {
				...
				if ( isset( $value['bg_settings_bg_src'] ) && '' != $value['bg_settings_bg_src'] ) {
					$background_image = 'background-image: url("' . $value['bg_settings_bg_src'] . '");';
				}
				if ( isset( $value['bg_settings_bg_color'] ) && '' != $value['bg_settings_bg_color'] ) {
					$background_color = 'background-color: ' . $value['bg_settings_bg_color'] . ';';
				}
				if ( isset( $value['bg_settings_bg_repeat'] ) && '' != $value['bg_settings_bg_repeat'] ) {
					$background_repeat = 'background-repeat: ' . $value['bg_settings_bg_repeat'] . ';';
				}
				if ( isset( $value['bg_settings_bg_size'] ) && '' != $value['bg_settings_bg_size'] ) {
					$background_size = 'background-size: ' . $value['bg_settings_bg_size'] . ';';
				}
				if ( isset( $value['bg_settings_bg_attachment'] ) && '' != $value['bg_settings_bg_attachment'] ) {
					$background_attachment = 'background-attachment: ' . $value['bg_settings_bg_attachment'] . ';';
				}
				if ( isset( $value['bg_settings_bg_position'] ) && '' != $value['bg_settings_bg_position'] ) {
					$background_position = 'background-position: ' . $value['bg_settings_bg_position'] . ';';
				}
				if ( isset( $value['border_bottom_width'] ) && '' != $value['border_bottom_width'] ) {
					$border_width = 'border-bottom-width: ' . $value['border_bottom_width'] . 'px;';
				}
				if ( isset( $value['border_bottom_style'] ) && '' != $value['border_bottom_style'] ) {
					$border_style = 'border-bottom-style: ' . $value['border_bottom_style'] . ';';
				}

				if ( isset( $value['border_bottom_color'] ) && '' != $value['border_bottom_color'] ) {
				...
				if ( isset( $value['border_bottom_border_width'] ) && 'container' == $value['border_bottom_border_width'] ) {
				...
				if ( '' != $link_hover_color ) {
					$header_customize .= '
						...
						.header-' . $key . ' .header-nav-wrapper .primary-menu > li > a:hover { ' . $link_hover_color . ' }';
				}
				...
				if ( '' != $link_border_top_hover_color ) {
					$header_customize .= '
				...
				if ( '' != $link_border_bottom_hover_color ) {
					$header_customize .= '
				...
				foreach ( $header_builder_elements[ $header_layouts ][ 'desktop_' . $header_layouts . '_' . $header_position ] as $inner_elements ) {
					...
					if ( isset( $inner_elements['menu'] ) ) {
						foreach ( $inner_elements['menu'] as $menu_elements ) {
							if ( isset( $menu_elements['name'] ) && 'menu_colors_color' == $menu_elements['name'] ) {
								$menu_color_schema[ $header_layouts ][ 'desktop_' . $header_layouts . '_' . $header_position ][ $count ][ $menu_elements['name'] ] = $menu_elements['value'];
							}

							if ( isset( $menu_elements['name'] ) && 'menu_colors_link_color' == $menu_elements['name'] ) {
								$menu_color_schema[ $header_layouts ][ 'desktop_' . $header_layouts . '_' . $header_position ][ $count ][ $menu_elements['name'] ] = $menu_elements['value'];
							}

							if ( isset( $menu_elements['name'] ) && 'menu_colors_hover_color' == $menu_elements['name'] ) {
								$menu_color_schema[ $header_layouts ][ 'desktop_' . $header_layouts . '_' . $header_position ][ $count ][ $menu_elements['name'] ] = $menu_elements['value'];
							}
						}
					}
					...
					foreach ( $header_builder_elements[ $header_layouts ][ 'mobile_' . $header_layouts . '_' . $header_position ] as $inner_elements ) {
						...
						if ( isset( $inner_elements['mobile_menu'] ) ) {
							foreach ( $inner_elements['mobile_menu'] as $menu_elements ) {
								...
								if ( isset( $menu_elements['name'] ) && 'menu_bg_color' == $menu_elements['name'] ) {
									$mobile_menu_schema[ $header_layouts ][ 'mobile_' . $header_layouts . '_' . $header_position ][ $count ][ $menu_elements['name'] ] = $menu_elements['value'];
								}
							}
						}
