...
function ciyashop_vc_iconpicker_type_flaticon( $icons ) {
	$icons_new = include( get_parent_theme_file_path( '/includes/icons/flaticon/flaticon.php' ) );
...
function ciyashop_vc_iconpicker_type_themefy( $icons ) {
	$icons_new = include( get_parent_theme_file_path( '/includes/icons/themefy/themefy.php' ) );
