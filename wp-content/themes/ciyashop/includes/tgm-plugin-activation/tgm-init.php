	...
	return apply_filters(
		...
		array(
			array(
				...
				'slug'               => 'pgs-core',
				'source'             => ciyashop_tgmpa_plugin_path( 'pgs-core-4.6.2.zip' ),
				'required'           => true,
			...
			array(
				...
				'slug'               => 'js_composer',
				'source'             => ciyashop_tgmpa_plugin_path( 'js_composer-6.1.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '6.1',
			...
			array(
				...
				'slug'               => 'mpc-massive',
				'source'             => ciyashop_tgmpa_plugin_path( 'mpc-massive-2.4.6.1.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '2.4.6.1',
			...
			array(
				...
				'slug'               => 'revslider',
				'source'             => ciyashop_tgmpa_plugin_path( 'revslider-6.2.2.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '6.2.2',
			...
			array(
				...
				'source'             => ciyashop_tgmpa_plugin_path( 'advanced-custom-fields-pro-5.8.7.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '5.8.7',
			...
			array(
				...
				'slug'              => 'envato-market',
				'source'            => ciyashop_tgmpa_plugin_path( 'envato-market-2.0.3.zip' ),
				'required'          => false,
				'version'           => '2.0.3',
