...
class Nav_Menu_Images {
	...
	public function init() {
		...
		require_once dirname( __FILE__ ) . '/inc/fields-helper.php';
		require_once dirname( __FILE__ ) . '/inc/menu-fields.php';
	...
	public function menu_item_hover( $attr, $attachment ) {
		$hover_id = get_post_meta( $attachment->post_parent, '_nmi_hover', true );
		if ( $hover_id && ! ( $this->is_current_item && get_post_meta( $attachment->post_parent, '_nmi_active', true ) ) ) {
	...
	public function menu_item_active( $attr, $attachment ) {
		$active_id = get_post_meta( $attachment->post_parent, '_nmi_active', true );
		if ( $this->is_current_item && $active_id ) {
