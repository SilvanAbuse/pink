...
class Nav_Menu_Images_Admin extends Nav_Menu_Images {
	...
	*******************************************/
	...
	public function pgs_update_menu_item_data() {
		...
		$menu_item_data = $_POST['menu_item_data'];
		...
		echo json_encode( $menu_item_data );
		die();
	}
	...
	*******************************************/
	...
	public function pgs_get_item_field() {
		...
		$menu_item_id   = sanitize_text_field( $_POST['menu_item_id'] );
		$menu_depth     = sanitize_text_field( $_POST['menu_depth'] );
		$parent_menu_id = sanitize_text_field( $_POST['parent_menu_id'] );

		$menu_item_label = '';

		if ( $_POST['menu_item_label'] ) {
			$menu_item_label = ' ( ' . sanitize_text_field( $_POST['menu_item_label'] ) . ' )';
		}
