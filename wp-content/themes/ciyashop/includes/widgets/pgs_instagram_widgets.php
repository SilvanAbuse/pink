							...
							<a href="<?php echo esc_url( $image['link'] ); ?>" class="pgs_instgram_widget--link" target="_blank">
								<div class="pgs_instgram_widget--content">
									...
									if ( isset( $ciyashop_options['enable_lazyload'] ) && $ciyashop_options['enable_lazyload'] ) {
										echo '<img class="pgs_instgram_widget--img ciyashop-lazy-load" src="' . esc_url( LOADER_IMAGE ) . '" data-src="' . esc_url( $image['thumbnail'] ) . '" alt="' . esc_attr__( 'Instagram Image', 'ciyashop' ) . '">';
									} else {
										echo '<img class="pgs_instgram_widget--img" src="' . esc_url( $image['thumbnail'] ) . '" alt="' . esc_attr__( 'Instagram Image', 'ciyashop' ) . '">';
									}
									?>
								</div>
							</a>
