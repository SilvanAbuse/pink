...
class PGS_social_widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>"><?php esc_html_e( 'style:', 'ciyashop' ); ?></label> 
			<select id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>" class="widefat">
				<option <?php selected( $style, 'default' ); ?> value="default"><?php esc_html_e( 'Default', 'ciyashop' ); ?></option>
				<option <?php selected( $style, 'colored' ); ?> value="colored"><?php esc_html_e( 'Colored', 'ciyashop' ); ?></option> 
				<option <?php selected( $style, 'dark-flat' ); ?> value="dark-flat"><?php esc_html_e( 'Dark Flat', 'ciyashop' ); ?></option>
				<option <?php selected( $style, 'light-flat' ); ?> value="light-flat"><?php esc_html_e( 'Light Flat', 'ciyashop' ); ?></option>
				<option <?php selected( $style, 'dark-border' ); ?> value="dark-border"><?php esc_html_e( 'Dark Border', 'ciyashop' ); ?></option>
				<option <?php selected( $style, 'light-border' ); ?> value="light-border"><?php esc_html_e( 'Light Border', 'ciyashop' ); ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'shape' ) ); ?>"><?php esc_html_e( 'shape:', 'ciyashop' ); ?></label> 
			<select id="<?php echo esc_attr( $this->get_field_id( 'shape' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'shape' ) ); ?>" class="widefat">
				<option <?php selected( $shape, 'square' ); ?> value="square"><?php esc_html_e( 'Square', 'ciyashop' ); ?></option>
				<option <?php selected( $shape, 'round' ); ?> value="round"><?php esc_html_e( 'Round', 'ciyashop' ); ?></option>
			</select>
		</p>
		<?php
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['style']   = ( ! empty( $new_instance['style'] ) ) ? strip_tags( $new_instance['style'] ) : 'square';
		$instance['shape']   = ( ! empty( $new_instance['shape'] ) ) ? strip_tags( $new_instance['shape'] ) : 'default';
