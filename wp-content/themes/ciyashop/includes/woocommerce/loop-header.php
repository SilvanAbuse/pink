...
function ciyashop_gridlist_toggle_button() {
	...
	<div class="gridlist-toggle-wrap">
		...
		<div class="gridlist-button-wrap">
			<div class="gridlist-toggle">
				<a href="#"  title="<?php echo esc_attr( $grid_view ); ?>" class="gridlist-button grid-2-column<?php echo esc_attr( ( 'products-loop-column-2' == $gridlist_view ) ? ' active' : '' ); ?>" data-grid='<?php echo esc_attr( json_encode( array( 'column' => 2 ) ) ); ?>'>
					<em><?php echo esc_html( $grid_view ); ?></em>
				</a>
				<a href="#"  title="<?php echo esc_attr( $grid_view ); ?>" class="gridlist-button grid-3-column<?php echo esc_attr( ( 'products-loop-column-3' == $gridlist_view ) ? ' active' : '' ); ?>" data-grid='<?php echo esc_attr( json_encode( array( 'column' => 3 ) ) ); ?>'>
					<em><?php echo esc_html( $grid_view ); ?></em>
				</a>
				<a href="#" title="<?php echo esc_attr( $grid_view ); ?>" class="gridlist-button grid-4-column<?php echo esc_attr( ( 'products-loop-column-4' == $gridlist_view ) ? ' active' : '' ); ?>" data-grid="<?php echo esc_attr( json_encode( array( 'column' => 4 ) ) ); ?>">
					<em><?php echo esc_html( $grid_view ); ?></em>
				</a>
				<?php
				if ( 5 == $pro_col_sel ) {
					?>
					<a href="#" title="<?php echo esc_attr( $grid_view ); ?>" class="gridlist-button grid-5-column<?php echo esc_attr( ( 'products-loop-column-5' == $gridlist_view ) ? ' active' : '' ); ?>" data-grid="<?php echo esc_attr( json_encode( array( 'column' => 5 ) ) ); ?>">
						<em><?php echo esc_html( $grid_view ); ?></em>
					</a>
					<?php
				}
				...
				<a href="#" title="<?php echo esc_attr( $list_view ); ?>" class="gridlist-button gridlist-toggle-list<?php echo esc_attr( ( 'list' == $gridlist_view ) ? ' active' : '' ); ?>">
					<em><?php echo esc_html( $list_view ); ?></em>
				</a>
			</div>
		</div>
	</div>
	<?php
	$output                        = ob_get_clean();
	$allowd_html                   = ciyashop_allowed_html( array( 'div', 'span', 'a', 'i', 'em' ) );
...
function ciyashop_product_search_redirection() {
	if ( isset( $_GET['filtering'] ) && 1 == $_GET['filtering'] ) {
