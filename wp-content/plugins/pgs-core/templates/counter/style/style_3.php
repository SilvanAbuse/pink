...
if ( isset( $use_google_font ) && $use_google_font == 'yes' && isset( $counter_google_fonts ) ) {
...
?>
<div class="pgscore-counter pgscore-counter-style-3 alignment-<?php echo esc_attr( $counter_alighnment ); ?>">
	<?php if ( ! $counter_icon_disable ) { ?>
		<?php if ( $counter_icon_source == 'font' ) { ?>
		<div class="pgscore-counter-icon pgscore-icon-<?php echo $counter_icon_source; ?> icon-size-<?php echo $counter_icon_size; ?>">
			<?php echo $icon_html; ?>
		</div>
		<?php } else { ?> 
		<div class="pgscore-counter-icon pgscore-icon-<?php echo $counter_icon_source; ?>">
			<?php echo $icon_html; ?>
		</div>
		<?php } ?>
	<?php } ?>
