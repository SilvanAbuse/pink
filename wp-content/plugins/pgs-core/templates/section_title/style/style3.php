...
?>
	<div class="<?php echo esc_attr( $classes ); ?>">
		...
		<<?php echo esc_attr( $main_title_el ); ?> class="divider-title" style="color:<?php echo esc_attr( $main_title_el_color ); ?>"><?php echo esc_html( $main_title ); ?></<?php echo esc_attr( $main_title_el ); ?>>				 				
