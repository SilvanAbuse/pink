		...
		<div class="image-gallery-info">
			<div class="image-gallery_item">
				<div class="pgscore_image-gallery_img">
					<?php if ( $image_gallery_style_disable ) { ?>
					<a href="<?php echo $image_full[0]; ?>" class="pgscore_image-gallery_hover image_popup-img icon-disable">
				...
				if ( ! $image_gallery_style_disable ) {
					?>
				<a style="background:<?php echo esc_attr( $image_overlay_color ); ?>" href="<?php echo $image_full[0]; ?>" class="pgscore_image-gallery_hover image_popup-img">
