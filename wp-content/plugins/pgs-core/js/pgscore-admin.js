...
( function( $ ){
    jQuery('.set-position-button').live('click', function(e) {
        e.preventDefault();
...
jQuery('.pgscore-position .pgscore-hotspot-cover .pgscore-hotspot-overlay').live('click', function(e) {
...
jQuery('.vc_param_group-add_content, .column_toggle').live('click', function(){
