jQuery( document ).ready(function() {
	...
	// Delete Element
	jQuery('.chl-element-content .chl-remove-btn').live('click', function() {
	...
	// Clone Element
	jQuery('.chl-element-content .chl-clone-btn').live('click', function() {
	...
	// Edit Element popup
	jQuery('.chl-element-sortable .chl-element-content-inner').live('click', function() {
	...
	jQuery('.chl-edit-tabs .chl-tabs-title').live('click', function() {
	...
	//Popup Close
	jQuery('.chl-popup-close, .chl-element-settings-close, .chl-popup-overlay, .chl-close-element, .chl-toolbar-devices').live('click', function(e) {
		e.preventDefault();
	...
	// Save Element
	jQuery('.chl-save-element').live('click', function(e) {
		e.preventDefault();
			...
			$element_data.forEach(function (item) {
				if (item.name === 'textarea_html') {
					...
					if( jQuery('#wp-textarea_html-wrap').hasClass('tmce-active') ){
						var textarea_html_data = tinymce.get('textarea_html').getContent();
					} else {
						var textarea_html_data = jQuery('textarea#textarea_html').val();
					}
	...
	//Save
	jQuery('.chl-save').live('click', function() {
	...
	// Configure Header
	jQuery('.chl-row-configure').live('click', function() {
	...
	jQuery('.chl-save-configuration').live('click', function() {
	...
	jQuery('.media-upload').live( 'click', function ( event ) {
	...
	jQuery('.chl-remove-media-button').live('click', function() {
		var $this = jQuery(this).parents('.chl-background-setting-field');
