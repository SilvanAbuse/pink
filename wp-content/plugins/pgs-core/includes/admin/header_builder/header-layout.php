		...
		<div class="header-layout-cover">
			...
			<div class="chl-header-builder-container">
				...
				<div class="chl-structure chl-structure-desktop">
					...
					<div class="chl-row chl-elements-cover chl-top-bar" data-possition="topbar" data-element_title="<?php _e( 'Top Bar', 'pgs-core' ); ?>" data-element_data='<?php echo ( '' != $topbar_configuration ) ? json_encode( $topbar_configuration ) : ''; ?>'>
					...
					<div class="chl-row chl-elements-cover chl-main-header" data-possition="main" data-element_title="<?php _e( 'Main Header', 'pgs-core' ); ?>" data-element_data='<?php echo ( '' != $main_configuration ) ? json_encode( $main_configuration ) : ''; ?>'>
						<div class="chl-element-inner">
					...
					<div class="chl-row chl-elements-cover chl-header-bottom" data-possition="bottom" data-element_title="<?php _e( 'Header Bottom', 'pgs-core' ); ?>" data-element_data='<?php echo ( '' != $bottom_configuration ) ? json_encode( $bottom_configuration ) : ''; ?>'>
						<div class="chl-element-inner">
