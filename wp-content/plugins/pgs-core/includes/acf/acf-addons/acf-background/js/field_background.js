...
(function($){
	...
	*/
	$.reyBackground.init = function(){
		...
		$( '.rey-container-background .remove-image, .rey-container-background .remove-file .wp-picker-container' ).unbind( 'click' ).on(
			'click',
			function(e) {
		...
		// Upload media button
		$( '.rey-container-background .background_upload_button' ).unbind().on(
			'click',
			function( event ) {
	...
	$.reyBackground.preview = function(selector) {
		...
		$( parent ).find( '.rey-background-input' ).each(
			function() {
