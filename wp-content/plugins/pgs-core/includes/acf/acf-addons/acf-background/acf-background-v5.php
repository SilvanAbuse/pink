							...
							echo '<div class="clearfix">';
								echo '<div class="acf-background-uplaod-fields" style="width: ' . $width_upload_fields . '">';
									echo '<div class="acf-background-img-url">';
										echo '<label class="acf-background-subfield-label" for="' . $field['name'] . '[' . $field['id'] . '][background-image]">' . __( 'Image URL:', 'acf-background' ) . '</label>';
...
// @jgraup:         Adding multiple methods for changing color and opacity with the keyboard.
	...
	*/
	...
	function input_admin_head() {
		...
		// register & include JS
		wp_register_script( 'acf-js-background', "{$dir}js/field_background" . $suffix . '.js' );
		wp_enqueue_script( 'acf-js-background' );

		// register & include CSS
		wp_register_style( 'acf-css-background', "{$dir}css/field_background" . $suffix . '.css' );
