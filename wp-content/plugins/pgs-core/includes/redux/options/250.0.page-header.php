	...
	'fields'           => array_merge( 
		array(
			...
			array(
				...
				'options'    => array(
					'color' => '<i class="fa fa-paint-brush" aria-hidden="true"></i> ' . esc_html__( 'Color', 'pgs-core' ),
					'image' => '<i class="fa fa-picture-o" aria-hidden="true"></i> ' . esc_html__( 'Image', 'pgs-core' ),
					'video' => '<i class="fa fa-video-camera" aria-hidden="true"></i> ' . esc_html__( 'Video', 'pgs-core' ),
				),
				'default'    => 'image',
			),
			array(
			...
			array(
				...
				'type'     => 'button_set',
				'options'  => array(
					'youtube' => '<i class="fa fa-youtube" aria-hidden="true"></i> ' . esc_html__( 'Youtube', 'pgs-core' ),
					'vimeo'  => '<i class="fa fa-vimeo" aria-hidden="true"></i> ' . esc_html__( 'Vimeo', 'pgs-core' ),
				),
				'select2'  => array(
					'allowClear' => 0,
				),
